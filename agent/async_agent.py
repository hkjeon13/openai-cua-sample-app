...
class AsyncAgent:
    ...
    def __init__(
        self,
        model: typing.Callable[[typing.List[typing.Dict[str, typing.Any]]], typing.Awaitable],
    ...
    async def run_full_turn(
        self, input_items, print_steps=True, debug=False, show_images=False, max_turns=100
    ):
